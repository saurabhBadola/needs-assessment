...
import in.sunfox.needs.assesment.databinding.FragmentPendingTasksBinding;
...
public class PendingTasksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewModel.startObservingPendingTasks();
        FragmentPendingTasksBinding binding = DataBindingUtil.inflate(LayoutInflater.from(requireContext()),R.layout.fragment_pending_tasks, container, false);
